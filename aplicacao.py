...
def main():
    try:
        ...
        imgR = r"C:\Users\princ\OneDrive - Insper - Institudo de Ensino e Pesquisa\Documentos\INSPER\4 periodo\camadas\imagem\mario.png"

        print ("Carregando imagem para trasmissão: ")
        print(" - {}".format(imgR))
        print("--------------")
        ...
        imgW = r"C:\Users\princ\OneDrive - Insper - Institudo de Ensino e Pesquisa\Documentos\INSPER\4 periodo\camadas\imagem\marioCopia.png"
